...
class Encoder(tf.keras.Model):
    ...
    def __init__(self, normalize=True, activation='relu'):
        ...
        self.hidden1 = Conv2D(filters=4, kernel_size=5, activation="relu")
        self.hidden2 = Conv2D(filters=10, kernel_size=5, activation="relu")
        self.hidden3 = MaxPool2D(pool_size=(2, 2), strides=(2, 2), padding="valid", data_format=None)
